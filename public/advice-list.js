export default [
  ...
  ["Designing Data Intensive Applications", "Allow quick and easy recovery from human errors, to minimize the impact in the case of a failure."],
  ["Designing Data Intensive Applications", "Anything that is meaningful to humans may need to change in the future."],
  ["Designing Data Intensive Applications", "Monitoring can show us early warning signals."],
  ["Designing Data Intensive Applications", "Reliability means making systems work correctly, even when faults occur."],
  ["Designing Data Intensive Applications", "Reliability: Continuing to work correctly, even when things go wrong."],
  ["Designing Data Intensive Applications", "Scalability is the term used to describe a system's ability to cope with increased load."],
  ["Designing Data Intensive Applications", "Scalability means having strategies for keeping performance good, even when load increases."],
  ...
  ["Domain Driven Design", "Anti Corruption Layer is used when the downstream model doesn’t want to be affected by an upstream model."],
